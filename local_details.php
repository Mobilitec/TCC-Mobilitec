...
$username = "root";
$password = "UFrJubUtvCfmqXCXYMTMgqGhywQfzGdn";
...
<head>
    ...
    <style>
        ...
        .container1 {
            ...
            border-radius: 8px;
            font-family: 'Sora', sans-serif;
            text-align: center; /* Centraliza o botão na tela */
        }
        ...
        /* Ajustes de responsividade para o botão "Voltar" */
        ...
        /* Ajustes de responsividade para o mapa */
        @media (min-width: 350px) {
            .map-container {
                height: 400px; /* Aumenta a altura em telas maiores */
            }
        }
